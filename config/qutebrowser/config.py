...
c.url.searchengines = {
    ...
    "eBooks_-_PDF_Drive": "https://www.pdfdrive.com/search?q={}",
    ...
    "MXToolBox_Blacklist_Lookup": "https://mxtoolbox.com/SuperTool.aspx?action=blacklist%3a{}&run=toolpage",
    "MXToolBox_DNS_Lookup_(A)": "https://mxtoolbox.com/SuperTool.aspx?action=a%3a{}&run=toolpage",
    "MXToolBox_DNS_Lookup_(DMARC)": "https://mxtoolbox.com/SuperTool.aspx?action=dmarc%3a{}&run=toolpage",
    "MXToolBox_DNS_Lookup_(MX)": "https://mxtoolbox.com/SuperTool.aspx?action=mx%3a{}&run=toolpage",
    "MXToolBox_DNS_Lookup_(SPF)": "https://mxtoolbox.com/SuperTool.aspx?action=spf%3a{}&run=toolpage",
    "MXToolBox_DNS_Lookup_(TXT)": "https://mxtoolbox.com/SuperTool.aspx?action=txt%3a{}&run=toolpage",
    "MXToolBox_SMTP_Test": "https://mxtoolbox.com/SuperTool.aspx?action=smtp%3a{}&run=toolpage",
    "MXToolBox_WHOIS": "https://mxtoolbox.com/SuperTool.aspx?action=whois%3a{}&run=toolpage",
    "MXToolBox_Email_Health": "https://mxtoolbox.com/emailhealth/{}/",
    ...
    "NVD_-_National_Vulnerability_Database": "https://nvd.nist.gov/vuln/search/results?form_type=Basic&results_type=overview&query={}&search_type=all",
    ...
    "Thomann_-_Audio_Gear": "https://www.thomann.de/be/search_dir.html?sw={}",
    ...
    "Wiktionary_-_EN": "https://en.wiktionary.org/wiki/{}",
    "Wiktionary_-_FR": "https://fr.wiktionary.org/wiki/{}",
    "WolframAlpha": "https://www.wolframalpha.com/input/?i={}",
    "Yelp_-_BE": "https://fr.yelp.be/search?find_desc={}",
